package org.tbch.tbchutils.util.config;
...
public final class ConfigUtil extends Configuration {
     ...
     */
    public ConfigUtil(JavaPlugin plugin, String fileName, boolean useUserDatabase) {
        super(new File(useUserDatabase ? new File(plugin.getDataFolder(), "userdata") : plugin.getDataFolder(), fileName));

        File parentFolder = useUserDatabase ? new File(plugin.getDataFolder(), "userdata") : plugin.getDataFolder();
